...
def main():
    # output_folder = 'q3a_binary_mnist_results_4lyrs'
    output_folder = 'debugging'
    ...
    train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=N_batch_size, shuffle=(not DEBUGGING))
    ...
    #     torch.load('/workspace/deepul/homeworks/hw1/q3a_binary_mnist_results/model_79.pt', weights_only=True)
    # )
    # model.eval()
    ...
    batch = next(iter(train_dataloader)).cuda()
    model.train()
